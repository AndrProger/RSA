...
public class CustomDES {
    ...
    private int[] IP_1 =
            {40, 8, 48, 16, 56, 24, 64, 32,
                    ...
                    33, 1, 41, 9, 49, 17, 57, 25}; // Руки отключены, данные массива записаны не все
    // Расширение E
    ...
    public static void main(String[] args) {
        String origin = "Текс текст шифровка текс";
        System.out.println("Оригинал: \n" + origin);
        CustomDES customDES = new CustomDES("Криптографическая колонка", origin);
...
//        / *********** Сжатие ПК-1 **************** /
        ...
        for (int i = 0; i < PC1.length; i++) {
            k_new_bit[i] = k_bit[PC1[i] - 1]; ///// Это минус 1 балл на заметку
        }
        /**************************/
        int[] c0 = new int[28];
        int[] d0 = new int[28];
        ...
        for (int i = 0; i < 16; i++) {
            ...
            if (LFT[i] == 1) {
                ...
                c1[26] = c0[0];
                c1[27] = c0[1]; // Здесь написано как c1 до травмы руки
